...
Esse trabalho, assim como o descrito aqui, apresenta o uso de um AVA para auxiliar na educação. Dessa forma, esse trabalho servirá como referência para abordar o uso da aprendizagem auto-ritmada na 
...
O trabalho referido,  assim como o desenvolvido por \citeonline{khan2012one} descrito anteriormente, descreve a criação de um AVA. Entretanto, o mesmo utiliza técnicas que permitem a geração dinâmica 
...
Nesse trabalho desenvolvido por \citeonline{fardo2013gamificaccao}, apresenta-se um conceito sobre gamificação, que vem ganhando visibilidade por sua capacidade de criar experiências significativas 
