...
tornou-se conveniente a criação de novas \index{metodologias de ensino}, especificamente na Educação Matemática. A 
busca por novas metodologias de ensino que fazem uso destes recursos procura fazer da matemática uma disciplina atraente e desvinculada do \index{ensino tradicional} que já se mostrou ineficiente 
\cite{silva2009ambiente}.

Grande parte dos estudantes tem dificuldades em \index{aprender} matemática, e muitas vezes essas dificuldades ocorrem não pela falta de atenção ou por não gostar do conteúdo, mas por fatores mentais 
