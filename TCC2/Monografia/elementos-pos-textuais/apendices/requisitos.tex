...
\parbox{\textwidth}{
  ...
  \end{center}
O Sistema deverá propiciar aos usuários uma opção para recuperar sua senha caso necessite.
\linebreak
Prioridade: Essencial
}}
...
desmarcar\'a esse campo e futuramente poderá editar o problema e marcá-lo 
quando quiser que os alunos passem a acessá-lo.
\linebreak
Prioridade: Essencial
}}
...
\parbox{\textwidth}{
  ...
  \end{center}
A cada 3 problemas seguidos que o aluno responder corretamente, ele será parabenizado e 
ganhará um prêmio. A cada erro, ele deverá ganhar uma pequena bonificação como incentivo a continuar praticando.
\linebreak
Prioridade: Essencial
}}
...
\UFCfig{}{
  \fbox{\includegraphics[width=\textwidth]{figuras/figura_casos_de_uso}}
}{
