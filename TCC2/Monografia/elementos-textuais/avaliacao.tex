...
M1 & Segurança no uso & \begin{tabular}[c]{@{}l@{}}Número de erros cometidos\\ para cada tarefa\end{tabular} & Por volta de 6 erros & No máximo 3 erros & Nenhum erro \\ \hline
M2 & Eficiência no uso & \begin{tabular}[c]{@{}l@{}}Número de cliques para \\ realizar uma tarefa\end{tabular} & Por volta de 6 cliques & No máximo 3 cliques & \multicolumn{1}{c|}{--} \\ \hline
M3 & Eficiência no uso & \begin{tabular}[c]{@{}l@{}}Tempo gasto para \\ encontrar a tela de autenticação\end{tabular} & Por volta de 1 minutos & No máximo 5 segundos & 2 segundos \\ \hline
M4 & Eficiência no uso & \begin{tabular}[c]{@{}l@{}}Tempo gasto para realizar \\ o cadastro no sistema\end{tabular} & Por volta de 5 minutos & No máximo 1 minuto & 20 segundos \\ \hline
M5 & Eficiência no uso & \begin{tabular}[c]{@{}l@{}}Tempo gasto para encontrar \\ uma lição\end{tabular} & Por volta de 4 minutos & No máximo 10 segundos & 5 segundos \\ \hline
M6 & Facilidade de aprendizado & \begin{tabular}[c]{@{}l@{}}Se entende corretamente as \\ informações da interface\end{tabular} & Por volta de 3 perguntas & Sem perguntas & Sem perguntas \\ \hline
M7 & Satisfação do usuário & \begin{tabular}[c]{@{}l@{}}Observação durante a \\ realização das atividades\end{tabular} & Demonstrou tédio ou frustração & Demonstrou prazer ou diversão & \begin{tabular}[c]{@{}l@{}}Demonstrou prazer\\ ou diversão\end{tabular} \\ \hline
M8 & Facilidade de memorização & \begin{tabular}[c]{@{}l@{}}Realização de uma \\ tarefa pela segunda vez\end{tabular} & \begin{tabular}[c]{@{}l@{}}Não conseguiu chegar no\\ objetivo ou usou outro \\ caminho para chegar\end{tabular} & \begin{tabular}[c]{@{}l@{}}Usou o mesmo \\ caminho da primeira vez\end{tabular} & \begin{tabular}[c]{@{}l@{}}Usou o mesmo \\ caminho da primeira vez\end{tabular} \\ \hline
\end{tabular}
...
\begin{enumerate}
	...
	\item Após as devidas explicações, foi iniciada a realização das tarefas, as quais foram descritas oralmente pelo avaliador. Nesta etapa, o avaliador requisitou que o participante verbalizasse suas dúvidas para ajudar o avaliador a coletar essas informações.
	...
	\item Após a entrevista, o entrevistador agradeceu o participante e lhe entregou um brinde como forma de agradecimento.  
\end{enumerate}
