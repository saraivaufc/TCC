...
M5 & Satisfação do usuário & \begin{tabular}[c]{@{}l@{}}Realização das atividades\\ (subjetivo)\end{tabular} & Demonstrou tédio ou frustração & Demonstrou prazer ou diversão & \begin{tabular}[c]{@{}l@{}}Demonstrou prazer\\ ou diversão\end{tabular} \\ \hline
M6 & Satisfação do usuário & \begin{tabular}[c]{@{}l@{}}Avaliação do usuário através\\ da entrevista(subjetivo)\end{tabular} & neutro & positivo & muito positivo \\ \hline
\end{tabular}
...
O objetivo do Teste Piloto foi identificar problemas ocasionados por ambiguidades e erros nos materiais de avaliação que poderiam prejudicar a avaliação. Após o teste, foram realizados correções no roteiro da entrevista e nas tarefas para o teste de usabilidade.
...
Na \autoref{tab:execucao_tarefas} apresentamos as medidas de tempo de execução das seis tarefas realizadas comparando-as com valores previamente estabelecidos: pior caso, nível almeijado e melhor caso.


\begin{table}[H]
	\Caption{\label{tab:execucao_tarefas}  Tempo de Execução das Tarefas em Segundos}%
	\IBGEtab{}{%
...
Participante 6 & 85s & 9s & - & 20s & 8s & 25s \\ \hline
\textbf{Média} & \textbf{88s} & \textbf{9s} & \textbf{-} & \textbf{46s} & \textbf{5s} & \textbf{39s} \\ \hline
Pior caso & 180 & 30s & - & 100 & 15s & 60s \\ \hline
Nível almeijado & 60s & 5s & - & 10s & 5s & 30s \\ \hline
Melhor caso & 20s & 2s & - & 4s & 3s & 15s \\ \hline
\end{tabular}
...
Pior caso & 2 & 2 & 2 & 2 & 2 & 2 \\ \hline
Nível almeijado & 0 & 0 & 0 & 0 & 0 & 0 \\ \hline
Melhor caso & 0 & 0 & 0 & 0 & 0 & 0 \\ \hline
\end{tabular}
...
Pior caso & 6 & 6 & 6 & 6 & 6 & 6 \\ \hline
Nível almeijado & 3 & 3 & 3 & 3 & 3 & 3 \\ \hline
Melhor caso & 3 & 2 & 2 & 3 & 3 & 3 \\ \hline
\end{tabular}
...
\subsection{Satisfação dos participantes na realização das tarefas}
