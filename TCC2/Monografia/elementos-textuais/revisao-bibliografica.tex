...
Podemos distinguir, mais claramente, um problema de um exercício matemático. ``Um problema matemático é uma situação que demanda a realização de uma sequência de ações ou operações para obter um resultado. Ou seja, a solução não está disponível de início, mas é possível construí-la'' \cite[p.~4]{nacionais1998terceiro}. Segundo \apud[p.4]{silveira2001problema}{deresoluccao}, 
...
problema se ele ainda não tem os meios para atingir tal objetivo'' \apud[p.4]{silveira2001problema}{deresoluccao}. 
\end{citacao}
...
Para \citeonline{valentini2010aprendizagem}, um \gls{ava} é um espaço social, constituído de interações cognitivo-sociais sobre (ou em torno de) um objeto de conhecimento no qual as pessoas interagem, mediadas pela linguagem da hipermídia, visando o processo de ensino-aprendizagem.
...
\begin{figure}[H]
    ...
    \UFCfig{}{
	\fbox{\includegraphics[width=8cm]{figuras/figura_estrutura_problema.png}}
    }{
...
\begin{figure}[H]
    \centering
    \Caption{\label{fig:ilustracao_aprendizagem} Exemplo de um possível percurso no ambiente}	
    \UFCfig{}{
	\fbox{\includegraphics[width=\textwidth]{figuras/proposta.png}}
    }{
      \Fonte{Do próprio autor.}
    }	
\end{figure}