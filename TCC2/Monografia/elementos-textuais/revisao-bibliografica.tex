...
A seguir, apresentaremos alguns importantes AVAs e uma an\'alise comparativa entre eles.

\subsection{\textit{Moodle}}
Conforme os autores Ribeiro e Mendonça (2007)??, 
\begin{citacao}
``O AVA \textit{Modular Object Oriented Distance Learning} (Moodle) é uma plataforma, \textit{Open Source}, ou seja, pode ser 
instalado, utilizado, modificado e mesmo distribuído. Seu desenvolvimento objetiva o gerenciamento de aprendizado e de trabalho 
colaborativo em ambiente virtual, permitindo a criação e administração de cursos \textit{on-line}, grupos de trabalho e comunidades
de aprendizagem''.
\end{citacao}

Este AVA segundo Garcia e Lacleta (2004)??, ``apresenta estrutura modular, ampla comunidade de desenvolvedores, grande quantidade de 
documentação, disponibilidade, escalabilidade, facilidade de uso, interoperabilidade, estabilidade e segurança''.

\subsection{TelEduc}
O AVA TelEduc, segundo Ribeiro e Mendonça (2007)\footnote{Avaliação dos Ambientes Virtuais de Aprendizagem Moodle, TelEduc e
Tidia - Ae: um estudo comparativo},

\begin{citacao}
``É uma plataforma \textit{Open Source}, um ambiente de suporte EAD. O seu desenvolvimento é realizado de acordo com as necessidades, 
tanto tecnológico como metodológicas, por desenvolvedores do Núcleo de Informática Aplicada à Educação (NIED) da Universidade Estadual de
Campinas (UNICAMP)''.
\end{citacao}

Em geral, o ambiente TelEduc é flexível e está dividido em duas partes: as ferramentas e o conteúdo correspondente à ferramenta selecionada.

\subsection{AulaNet}
O ambiente Aulanet (http://anauel.cead.puc-rio.br/aulanet2/) foi criado em 1997 pelo Laboratório de Engenharia de Software do 
Departamento de Informática da Pontifícia Universidade Católica do Rio de Janeiro. Sendo este, um ambiente de software
baseado na web para criar, administrar, manter e dar assistência a cursos a distância.
